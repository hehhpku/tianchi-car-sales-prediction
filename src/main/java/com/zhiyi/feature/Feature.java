...
public class Feature {
    ...
    public static void main(String[] args) throws OdpsException {
        ...
        InputUtils.addTable(TableInfo.builder().tableName("car_sales_filled").build(), job);
        OutputUtils.addTable(TableInfo.builder().tableName("car_sales_feature").build(), job);
